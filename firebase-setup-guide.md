...
## Environment Variables (Optional - for sensitive data)

For production, consider storing credentials in environment variables rather than committing them to version control. For a static site, you can use `.env` files with build tools or GitHub Actions secrets.
