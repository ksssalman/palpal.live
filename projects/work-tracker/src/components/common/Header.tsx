    ...
    <div className="bg-gradient-to-r from-purple-800 to-purple-950 text-white shadow-xl relative z-50">
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold tracking-tight text-purple-50 hidden sm:block">Work Tracker</h1>
        </div>

        {/* Navigation Tabs - Centered/Pill Style */}
        <div className="flex bg-black/20 p-1 rounded-xl backdrop-blur-sm border border-white/5 mx-2">
          <button
            onClick={() => setView('tracker')}
            className={`flex items-center gap-2 px-4 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 ${view === 'tracker'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 ${view === 'report'
                ? 'bg-white text-purple-900 shadow-sm'
                : 'text-purple-200 hover:text-white hover:bg-white/5'
              }`}
          >
