  ...
  return (
    <div className="w-full">
      ...
      <nav className="fixed top-0 left-0 right-0 h-[70px] px-8 flex items-center justify-between bg-white/80 backdrop-blur-md border-b border-[#541342]/10 z-[1000] transition-all duration-300">
        <a href="https://palpal.live" className="text-2xl font-extrabold text-[#541342] tracking-tight no-underline flex items-center gap-2" style={{ fontFamily: '"Adobe Garamond Pro", Garamond, Georgia, "Times New Roman", serif', textTransform: 'lowercase', fontStyle: 'italic' }}>
          PalPal
        </a>
